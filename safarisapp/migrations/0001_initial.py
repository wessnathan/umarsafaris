# Generated by Django 3.0.5 on 2021-06-02 17:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Category', models.CharField(choices=[('DEL', 'DL1'), ('Rook', 'RK1'), ('Bishop', 'BP1'), ('Castle', 'CST1')], default=0, max_length=11)),
            ...
            options={
                'verbose_name_plural': 'Post Available Apartments ',
            },
        ),
        migrations.CreateModel(
            name='Carfeatures',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Apartments_Available', models.CharField(choices=[('DEL', (('DL1', 'D1'), ('DL2', 'D2'))), ('Rook', 'RK1'), ('Bishop', 'BP1'), ('Castle', 'CST1')], default=0, max_length=11)),
